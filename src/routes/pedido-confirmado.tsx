        ...
        <section className="bg-card border rounded-2xl p-6 md:p-10 text-center shadow-sm">
          ...
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              Seu pedido foi registrado no sistema da Dona Dora. Nossa equipe irá
          ...
          <div className="grid sm:grid-cols-3 gap-3 mt-8 text-left">
            <div className="border rounded-xl p-4 bg-background">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Seus produtos foram enviados para análise da loja.
              </p>
            </div>
            ...
            <div className="border rounded-xl p-4 bg-background">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                A equipe confirma disponibilidade, tamanhos e condições.
              </p>
            </div>
            ...
            <div className="border rounded-xl p-4 bg-background">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Pagamento e entrega serão combinados diretamente com a loja.
              </p>
            </div>
          </div>
